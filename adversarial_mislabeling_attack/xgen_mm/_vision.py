...
DEFAULT_CACHE_DIR = ATTACK_DIR / "representations/xgen_mm_phi3_mini_instruct_r_v1"
...
class Representations:
    ...
    def initialize_model(self):
        ...
        # The author attack does not cast this model/its inputs to FP16.
        model = AutoModelForVision2Seq.from_pretrained(MODEL_ID, revision=MODEL_REVISION, trust_remote_code=True)
        ...
        if (config.model_name != "ViT-H-14-378-quickgelu" or not self.blocks
                or tuple(vision.image_size) != (IMAGE_SIZE, IMAGE_SIZE)
        ...
        # OpenCLIP 2.24 uses LND inside blocks; newer versions can use NLD.
        # Read the actual MultiheadAttention setting, never infer it from dimensions.
